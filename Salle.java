...
public class Salle extends javax.swing.JFrame {
   ...
   // Statement stm;
    ...
    public Salle() {
     ...
     // model.addColumn("COEFFICIENT");
      ...
      try{
          ...
          while(Rs.next()){
              model.addRow(new Object[]{Rs.getString("numero"),Rs.getString("libelle")});
          }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GESTION SALLES");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtnum, javax.swing.GroupLayout.PREFERRED_SIZE, 399, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
...
//La modification 
        ...
        try{
            ...
            String sql;
            sql = "insert into salle(numero, libelle)VALUES(?,?)";
...
***/
    ...
    //Les changement
        try{
            ...
            cnx=DriverManager.getConnection("jdbc:mysql://localhost:3306/gesetablissement", "root", "");         
            String sql;
            sql = "update salle set libelle=? where code=?";
            pst = cnx.prepareStatement(sql);
   ...
   //   txtcoef.setText("");
    ...
    private void butonsupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butonsupActionPerformed
        ...
        try{
            ...
            cnx=DriverManager.getConnection("jdbc:mysql://localhost:3306/gesetablissement", "root", "");         
            String sql;
            sql = "delete from salle where numero=?";
            pst = cnx.prepareStatement(sql);
            pst.setString(1,txtnum.getText());
            pst.executeUpdate();
            cnx.close();
   ...
   //fin d
    ...
    public void TableEtudiant(){
        String[] etudiant={"NUMERO","LIBELLE"};
    ...
    //Pour Rechercher
        ...
        String[] afficher=new String[6];
        DefaultTableModel model=new DefaultTableModel(null,etudiant);
        String sql="select * from salle where numero like'%"+valeur+"'";
        try{
            Class.forName("com.mysql.jdbc.Driver");
            String url="jdbc:mysql://localhost/gesetablissement";
            String user="root";
