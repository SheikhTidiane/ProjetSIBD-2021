   ...
   // Statement stm;
    ...
    public Professeur() {
      ...
      try{
          ...
          while(Rs.next()){
              model.addRow(new Object[]{Rs.getString("id"),Rs.getString("nom"),Rs.getString("prenom"),Rs.getString("grade")});
          }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("GESTION PROFESSEURS");
        ...
        boutonmod.setForeground(new java.awt.Color(51, 0, 153));
        ...
        butonsup.setForeground(new java.awt.Color(0, 0, 153));
        ...
        boutonaj.setForeground(new java.awt.Color(51, 0, 153));
        ...
        boutonmod1.setForeground(new java.awt.Color(51, 0, 153));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(txtprenom, javax.swing.GroupLayout.PREFERRED_SIZE, 399, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtgrade, javax.swing.GroupLayout.PREFERRED_SIZE, 399, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(49, 49, 49)
...
//La modification 
        ...
        try{
            ...
            String sql;
            sql = "insert into professeur(id, nom, prenom, grade)VALUES(?,?,?,?)";
...
***/
    ...
    //Les changement
        try{
            ...
            cnx=DriverManager.getConnection("jdbc:mysql://localhost:3306/gesetablissement", "root", "");         
            String sql;
            sql = "update professeur set nom=?,prenom=?, grade=? where id=?";
            pst = cnx.prepareStatement(sql);
            pst.setString(4,txtid.getText());
            pst.setString(1,txtnom.getText());
            pst.setString(2,txtprenom.getText());
            pst.setString(3,txtgrade.getText());
            pst.executeUpdate();
            cnx.close();
   ...
   //fin d
    ...
    public void TableEtudiant(){
        String[] etudiant={"ID","NOM","PRENOM","GRADE"};
    ...
    //Pour Rechercher
        ...
        String[] afficher=new String[6];
        DefaultTableModel model=new DefaultTableModel(null,etudiant);
        String sql="select * from professeur where prenom like'%"+valeur+"'";
        try{
            Class.forName("com.mysql.jdbc.Driver");
            String url="jdbc:mysql://localhost/gesetablissement";
            String user="root";
